...
public class SimulationView extends StackPane {
    ...
    public SimulationView(PlanetConfig config, FirebaseAuthService authService, DatabaseController databaseController) {
        this(SimulationModel.buildInitialState(config), authService, databaseController);
    }

    public SimulationView(GameState initialState, FirebaseAuthService authService, DatabaseController databaseController) {
    ...
    private HBox buildTopBar() {
        ...
        HBox topBar = new HBox(12, titleBlock, leftSpacer, topStats, rightSpacer, save, end);
